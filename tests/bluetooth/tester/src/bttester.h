...
struct mesh_cfg_val_get {
	uint16_t net_idx;
	uint16_t address;
} __packed;

#define MESH_CFG_BEACON_SET		0x16
struct mesh_cfg_beacon_set {
	uint16_t net_idx;
	uint16_t address;
	uint8_t val;
} __packed;
...
struct mesh_cfg_default_ttl_set {
	uint16_t net_idx;
	uint16_t address;
	uint8_t val;
} __packed;
...
struct mesh_cfg_gatt_proxy_set {
	uint16_t net_idx;
	uint16_t address;
	uint8_t val;
} __packed;
...
struct mesh_cfg_model_app_bind {
	uint16_t net_idx;
	uint16_t address;
	uint16_t elem_address;
	uint16_t app_key_idx;
...
struct mesh_cfg_heartbeat_pub_set {
	uint16_t net_idx;
	uint16_t address;
	uint16_t net_key_idx;
...
struct mesh_cfg_heartbeat_sub_set {
	uint16_t net_idx;
	uint16_t address;
	uint16_t source;
	uint16_t destination;
...
struct mesh_cfg_model_sub_del_all {
	uint16_t net_idx;
	uint16_t address;
	uint16_t elem_address;
	uint16_t model_id;
...
struct mesh_cfg_model_sub_get_vnd {
	uint16_t net_idx;
	uint16_t address;
	uint16_t elem_address;
	uint16_t model_id;
...
struct mesh_cfg_node_reset {
	uint16_t net_idx;
	uint16_t address;
} __packed;

#define MESH_CFG_LPN_TIMEOUT_GET		0x40
struct mesh_cfg_lpn_timeout {
	uint16_t net_idx;
	uint16_t address;
...
struct mesh_cfg_model_pub_va_set {
	uint16_t net_idx;
	uint16_t address;
	uint16_t elem_address;
	uint16_t model_id;
	...
	uint8_t transmit;
	uint8_t virt_address_len;
	uint8_t virt_address[16];
} __packed;

#define MESH_CFG_MODEL_APP_BIND_VND		0x42
struct mesh_cfg_model_app_bind_vnd {
	uint16_t net_idx;
	uint16_t address;
	uint16_t elem_address;
	uint16_t app_key_idx;
...
struct mesh_health_fault_clear {
	uint16_t address;
	uint16_t app_idx;
	uint16_t cid;
	uint8_t ack;
...
struct mesh_health_period_get {
	uint16_t address;
	uint16_t app_idx;
} __packed;

#define MESH_HEALTH_PERIOD_SET		0x47
struct mesh_health_period_set {
	uint16_t address;
	uint16_t app_idx;
	uint8_t divisor;
	uint8_t ack;
...
struct mesh_health_attention_get {
	uint16_t address;
	uint16_t app_idx;
} __packed;

#define MESH_HEALTH_ATTENTION_SET		0x49
struct mesh_health_attention_set {
	uint16_t address;
	uint16_t app_idx;
	uint8_t attention;
	uint8_t ack;
