...
static void supported_commands(uint8_t *data, uint16_t len)
{
	...
	tester_set_bit(buf->data, MESH_COMP_DATA_GET);
	tester_set_bit(buf->data, MESH_CFG_BEACON_GET);
	tester_set_bit(buf->data, MESH_CFG_BEACON_SET);
	tester_set_bit(buf->data, MESH_CFG_DEFAULT_TTL_GET);
	/* 4th octet */
	(void)memset(net_buf_simple_add(buf, 1), 0, 1);
	tester_set_bit(buf->data, MESH_CFG_DEFAULT_TTL_SET);
	tester_set_bit(buf->data, MESH_CFG_GATT_PROXY_GET);
	tester_set_bit(buf->data, MESH_CFG_GATT_PROXY_SET);
	tester_set_bit(buf->data, MESH_CFG_FRIEND_GET);
	tester_set_bit(buf->data, MESH_CFG_FRIEND_SET);
	tester_set_bit(buf->data, MESH_CFG_RELAY_GET);
	tester_set_bit(buf->data, MESH_CFG_RELAY_SET);
	tester_set_bit(buf->data, MESH_CFG_MODEL_PUB_GET);
	/* 5th octet */
	(void)memset(net_buf_simple_add(buf, 1), 0, 1);
	tester_set_bit(buf->data, MESH_CFG_MODEL_PUB_SET);
	tester_set_bit(buf->data, MESH_CFG_MODEL_SUB_ADD);
	tester_set_bit(buf->data, MESH_CFG_MODEL_SUB_DEL);
	tester_set_bit(buf->data, MESH_CFG_NETKEY_ADD);
	tester_set_bit(buf->data, MESH_CFG_NETKEY_GET);
	tester_set_bit(buf->data, MESH_CFG_NETKEY_DEL);
	tester_set_bit(buf->data, MESH_CFG_APPKEY_ADD);
	tester_set_bit(buf->data, MESH_CFG_APPKEY_DEL);
	/* 6th octet */
	(void)memset(net_buf_simple_add(buf, 1), 0, 1);
	tester_set_bit(buf->data, MESH_CFG_APPKEY_GET);
	tester_set_bit(buf->data, MESH_CFG_MODEL_APP_BIND);
	tester_set_bit(buf->data, MESH_CFG_MODEL_APP_UNBIND);
	tester_set_bit(buf->data, MESH_CFG_MODEL_APP_GET);
	tester_set_bit(buf->data, MESH_CFG_MODEL_APP_VND_GET);
	tester_set_bit(buf->data, MESH_CFG_HEARTBEAT_PUB_SET);
	tester_set_bit(buf->data, MESH_CFG_HEARTBEAT_PUB_GET);
	tester_set_bit(buf->data, MESH_CFG_HEARTBEAT_SUB_SET);
	/* 7th octet */
	(void)memset(net_buf_simple_add(buf, 1), 0, 1);
	tester_set_bit(buf->data, MESH_CFG_HEARTBEAT_SUB_GET);
	tester_set_bit(buf->data, MESH_CFG_NET_TRANS_GET);
	tester_set_bit(buf->data, MESH_CFG_NET_TRANS_SET);
	tester_set_bit(buf->data, MESH_CFG_MODEL_SUB_OVW);
	tester_set_bit(buf->data, MESH_CFG_MODEL_SUB_DEL_ALL);
	tester_set_bit(buf->data, MESH_CFG_MODEL_SUB_GET);
	tester_set_bit(buf->data, MESH_CFG_MODEL_SUB_GET_VND);
	tester_set_bit(buf->data, MESH_CFG_MODEL_SUB_VA_ADD);
	/* 8th octet */
	(void)memset(net_buf_simple_add(buf, 1), 0, 1);
	tester_set_bit(buf->data, MESH_CFG_MODEL_SUB_VA_DEL);
	tester_set_bit(buf->data, MESH_CFG_MODEL_SUB_VA_OVW);
	tester_set_bit(buf->data, MESH_CFG_NETKEY_UPDATE);
	tester_set_bit(buf->data, MESH_CFG_APPKEY_UPDATE);
	tester_set_bit(buf->data, MESH_CFG_NODE_IDT_SET);
	tester_set_bit(buf->data, MESH_CFG_NODE_IDT_GET);
	tester_set_bit(buf->data, MESH_CFG_NODE_RESET);
	tester_set_bit(buf->data, MESH_CFG_LPN_TIMEOUT_GET);
	/* 9th octet */
	(void)memset(net_buf_simple_add(buf, 1), 0, 1);
	tester_set_bit(buf->data, MESH_CFG_MODEL_APP_BIND_VND);
	tester_set_bit(buf->data, MESH_HEALTH_FAULT_GET);
	tester_set_bit(buf->data, MESH_HEALTH_FAULT_CLEAR);
	tester_set_bit(buf->data, MESH_HEALTH_PERIOD_GET);
	...
	/* 10th octet */
	(void)memset(net_buf_simple_add(buf, 1), 0, 1);
	tester_set_bit(buf->data, MESH_CFG_KRP_GET);
	tester_set_bit(buf->data, MESH_CFG_KRP_SET);
...
{
	struct mesh_cfg_krp_get *cmd = (void *)data;
	...
	err = bt_mesh_cfg_krp_get(cmd->net_idx, cmd->address, cmd->key_net_idx,
				  &status, &phase);
	if (err) {
		LOG_ERR("err %d", err);
		goto fail;
	...
	tester_send(BTP_SERVICE_ID_MESH, MESH_CFG_KRP_GET, CONTROLLER_INDEX,
		    buf->data, buf->len);
	return;
...
{
	struct mesh_cfg_krp_set *cmd = (void *)data;
	struct net_buf_simple *buf = NET_BUF_SIMPLE(2);
	uint8_t status;
	uint8_t phase;
	int err;
	...
	err = bt_mesh_cfg_krp_set(cmd->net_idx, cmd->address, cmd->key_net_idx,
				  cmd->transition, &status, &phase);
	if (err) {
		LOG_ERR("err %d", err);
		goto fail;
	}
	...
	tester_send(BTP_SERVICE_ID_MESH, MESH_CFG_KRP_SET, CONTROLLER_INDEX,
		    buf->data, buf->len);
	return;
...
{
	struct mesh_cfg_val_get *cmd = (void *)data;
	uint8_t status;
	int err;
...
{
	struct mesh_cfg_beacon_set *cmd = (void *)data;
	uint8_t status;
	int err;
...
{
	struct mesh_cfg_default_ttl_set *cmd = (void *)data;
	uint8_t status;
	int err;
...
{
	struct mesh_cfg_gatt_proxy_set *cmd = (void *)data;
	uint8_t status;
	int err;
...
{
	struct mesh_cfg_friend_set *cmd = (void *)data;
	uint8_t status;
	int err;
...
{
	struct mesh_cfg_relay_set *cmd = (void *)data;
	uint8_t status;
	uint8_t transmit;
	int err;
...
{
	struct mesh_cfg_model_pub_get *cmd = (void *)data;
...
{
	struct mesh_cfg_model_pub_set *cmd = (void *)data;
	uint8_t status;
	struct bt_mesh_cfg_mod_pub pub;
	int err;
...
{
	struct mesh_cfg_model_pub_va_set *cmd = (void *)data;
	uint8_t status;
	...
	memcpy(pub.addr, cmd->virt_address, sizeof(cmd->virt_address));
	pub.app_idx = cmd->app_idx;
	pub.cred_flag = cmd->cred_flag;
	pub.ttl = cmd->ttl;
	pub.period = cmd->period;
	...
	err = bt_mesh_cfg_mod_pub_va_set(cmd->net_idx, cmd->address,
					 cmd->elem_address, cmd->model_id, &pub,
					 &status);
...
{
	struct mesh_cfg_model_sub *cmd = (void *)data;
	uint8_t status;
	int err;
...
{
	struct mesh_cfg_model_sub_del_all *cmd = (void *)data;
	uint8_t status;
	int err;
...
{
	struct mesh_cfg_model_sub_get *cmd = (void *)data;
	uint8_t status;
	int16_t subs;
	size_t sub_cn;
	int err;
...
{
	struct mesh_cfg_model_sub_get_vnd *cmd = (void *)data;
	uint8_t status;
	uint16_t subs;
	size_t sub_cn;
	int err;
...
{
	struct mesh_cfg_model_sub_va *cmd = (void *)data;
	uint8_t status;
	...
	err = bt_mesh_cfg_mod_sub_va_add(cmd->net_idx, cmd->address,
					 cmd->elem_address, cmd->virt_address,
...
{
	struct mesh_cfg_netkey_add *cmd = (void *)data;
	uint8_t status;
	int err;
...
{
	struct mesh_cfg_netkey_del *cmd = (void *)data;
	uint8_t status;
	int err;
...
{
	struct mesh_cfg_appkey_add *cmd = (void *)data;
	uint8_t status;
	int err;
...
{
	struct mesh_cfg_appkey_del *cmd = (void *)data;
	uint8_t status;
	int err;
...
{
	struct mesh_cfg_appkey_get *cmd = (void *)data;
	uint8_t status;
	uint16_t keys;
	size_t key_cnt;
	int err;
...
{
	struct mesh_cfg_model_app_bind *cmd = (void *)data;
	uint8_t status;
	int err;
...
{
	struct mesh_cfg_model_app_bind_vnd *cmd = (void *)data;
	uint8_t status;
	int err;
...
{
	struct mesh_cfg_model_app_get *cmd = (void *)data;
	uint8_t status;
	uint16_t apps;
	size_t app_cnt;
	int err;
...
{
	struct mesh_cfg_heartbeat_pub_set *cmd = (void *)data;
	uint8_t status;
...
{
	struct mesh_cfg_heartbeat_sub_set *cmd = (void *)data;
	uint8_t status;
...
{
	struct mesh_cfg_net_trans_set *cmd = (void *)data;
	uint8_t transmit;
	int err;
...
{
	struct mesh_cfg_node_idt_set *cmd = (void *)data;
	struct net_buf_simple *buf = NET_BUF_SIMPLE(2);
	uint8_t identity;
	uint8_t status;
	int err;
...
{
	struct mesh_cfg_node_idt_get *cmd = (void *)data;
	struct net_buf_simple *buf = NET_BUF_SIMPLE(2);
	uint8_t identity;
	uint8_t status;
	int err;
...
{
	struct mesh_cfg_node_reset *cmd = (void *)data;
	bool status;
	int err;
...
{
	struct mesh_health_fault_get *cmd = (void *)data;
	uint8_t test_id;
	uint8_t faults;
	size_t fault_count;
	int err;
...
{
	struct mesh_health_fault_clear *cmd = (void *)data;
	uint8_t test_id;
	uint8_t faults;
	size_t fault_count;
	int err;
...
{
	struct mesh_health_period_get *cmd = (void *)data;
	uint8_t divisor;
	int err;
...
{
	struct mesh_health_period_set *cmd = (void *)data;
...
{
	struct mesh_health_attention_get *cmd = (void *)data;
	uint8_t attention;
	int err;
...
{
	struct mesh_health_attention_set *cmd = (void *)data;
